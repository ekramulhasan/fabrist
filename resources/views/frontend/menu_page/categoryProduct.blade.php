                            ...
                            <div
                                ...
                                <div class="product-inner tooltip-top">
                                    <div class="product-thumb">
                                        <a class="thumb-link" href="{{ route('productDetails.page',[$product->slug]) }}" tabindex="0">
                                            <img class="img-responsive" src="{{ asset('assets/uploads/products') }}/{{ $product->product_img }}"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3 class="product-name product_title">
                                            <a href="{{ route('productDetails.page',[$product->slug]) }}" tabindex="0">{{ $product->title }}</a>
                                        </h3>
                                    ...
                                    <div class="group-button clearfix">
                                        ...
                                        <div class="add-to-cart">
                                            <a href="{{ route('productDetails.page',[$product->slug]) }}" class="button product_type_grouped">
                                                View products</a>
                                        </div>
